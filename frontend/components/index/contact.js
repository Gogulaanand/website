...
export default function contactForm() {
  ...
  return (
    <div id="contact">
      ...
      <div className="mx-auto my-12 grid grid-cols-6 w-4/5 justify-items-center">
        <SvgContact className="lg:col-span-3 col-span-3 hidden md:block" />
        <div className="lg:col-span-2 col-span-6 mt-10 md:mx-auto w-auto">
