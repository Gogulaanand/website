...
export default function Footer() {
  return (
    <>
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-gray100 border-gray-200 border-t">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <Link href="tel:701-073-5151" passHref>
                <a
            ...
            <div className="flex">
              ...
              <Link href="mailto:sunfabb.website@gmail.com" passHref>
                <a
                  aria-label="Our email"
                  title="Our email"
                  className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800  cursor-pointer"
                >
                  sunfabb.website@gmail.com
                </a>
              </Link>
            </div>
          </div>
          <div>
            ...
            <div className="flex items-center mt-1 space-x-3">
              <Link href="/" passHref>
                <div className="text-gray-900 transition-colors duration-300 hover:text-deep-purple-accent-400 cursor-pointer">
        ...
        <div className="flex justify-center pt-5 pb-10 text-sm text-gray-900">
